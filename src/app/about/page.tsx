...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950">
      {/* Hero Section */}
      <div className="relative py-16 bg-rose-50 dark:bg-slate-900 overflow-hidden">
      ...
      <Section>
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-rose-100 text-rose-500 text-xs font-bold uppercase tracking-wider dark:bg-rose-900/30 dark:text-rose-300">
              {t('our_story')}
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
            {[
                ...
                <div key={i} className="bg-white dark:bg-slate-800 p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 text-center hover:-translate-y-2 transition-transform duration-300">
                    <div className="w-16 h-16 bg-rose-50 dark:bg-slate-700 rounded-2xl flex items-center justify-center text-3xl mb-6 mx-auto shadow-inner">
                        {value.icon}
                    </div>
      ...
      {/* Team/Contact CTA */}
      <Section>
        <div className="bg-gradient-to-br from-rose-400 to-blue-600 rounded-3xl p-12 text-center text-white shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-2xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
                    <Link href="/contact">
                        <Button className="inline-block bg-white text-rose-400 px-8 py-3 rounded-xl font-bold hover:bg-rose-50 transition-colors shadow-lg">
                            {t('contact_us')}
                        </Button>
                    </Link>
                    <Link href="/products">
                        <Button variant="outline" className="inline-block bg-rose-400 text-white border border-rose-300 px-8 py-3 rounded-xl font-bold hover:bg-rose-500 transition-colors">
                            {t('start_shopping')}
                        </Button>
                    </Link>
                </div>
